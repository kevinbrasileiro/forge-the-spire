  ...
  return (
    <>
      ...
      {createPortal(
          <div
            ref={tooltipRef}
            className={`fixed px-3 py-2 bg-black-dark border border-black-light rounded-lg text-sm whitespace-nowrap z-[9999] shadow-lg pointer-events-none transition-opacity duration-150 ${show ? 'opacity-100' : 'opacity-0'} ${contentClassName}`}
            style={{
